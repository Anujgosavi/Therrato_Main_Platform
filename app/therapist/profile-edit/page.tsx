...
const mockTherapistProfile = {
  ...
  price: "85",
  selectedSpecializations: ["Anxiety", "Depression", "Trauma", "Stress Management"],
  availability: ["mon", "wed", "fri"],
  availabilityTimes: {
    mon: ["9:00 AM", "10:00 AM", "11:00 AM", "1:00 PM"],
    wed: ["9:00 AM", "10:00 AM", "2:00 PM", "3:00 PM"],
    fri: ["10:00 AM", "11:00 AM", "1:00 PM", "2:00 PM"],
  },
  profileImage: null,
  previewImage:
...
export default function TherapistProfileEditPage() {
  const [formData, setFormData] = useState(mockTherapistProfile)
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // In a real app, this would make an API call to update the therapist profile
    toast({
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Update your profile information to keep it current for your patients.</p>
        </div>
